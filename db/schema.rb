...
ActiveRecord::Schema.define(version: 2019_02_08_065932) do
  ...
  create_table "sub_menus", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.integer "menu_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "subnavs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.integer "nav_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
