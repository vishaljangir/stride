class TrainingVideo < ApplicationRecord
    ...
    validates_length_of :link, :maximum=>50, :message=>" length of words can not be accepted"
    validates_length_of :caption, :maximum=>80, :message=>" length of characters can not be over 30"
